...
/*My code is not functional but I believe I understand the implementation we are trying to reach!
 ...
 Below I've tried to implement the middleware to do this. It should function by taking the request, creating the response and then sending that back to the client side. I've also tried to this by following the psr-7 and 15 standards and interfaces that come with these. I've tried many resources but cant seem to get the response I wanted from the apache server I have set up at home.
